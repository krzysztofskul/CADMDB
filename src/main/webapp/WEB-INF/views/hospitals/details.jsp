                                ...
                                <div class="row mt-2 mb-2 h5 border-0">
                                    ...
                                    <c:if test="${hospital.employeeList eq null || hospital.employeeList.size() == 0}">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <a href="/hospitals/${hospital.id}/addEmployee" class="text-success">&#10010; ADD USER / EMPLOYEE</a>
                                            </div>
                                        </div>
                                    </c:if>
                                    <c:if test="${hospital.employeeList ne null &&  hospital.employeeList.size() != 0}">
                                        <div class="row border-0">
                                            <div class="col-sm-8">${hospital.employeeList.size()} users / employees</div>
                                            <div class="col-sm-4">
                                                <%--<a href="#" class="text-primary">&#8646; EDIT USERS / EMPLOYEES</a>--%>
                                                <a href="/hospitals/${hospital.id}/addEmployee" class="text-success">&#10010; ADD USER / EMPLOYEE</a>
                                            </div>
                                        </div>
                                        <c:forEach items="${hospital.employeeList}" var="employee">
                                            <div class="row border-top border-bottom pt-1 pb-1 m-auto">
                                                ...
                                                <div class="col-sm-2">
                                                    <a href="/hospitals/${hospital.id}/dismissEmployee?userId=${employee.id}" class="btn btn-danger">DISMISS</a>
                                                </div>
                                            </div>
                                        </c:forEach>
                                    </c:if>
